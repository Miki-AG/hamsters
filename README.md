...
**A native macOS GUI for batch AI processing, distributed as a single .command file.**
...
Read my [Hamsters blog entry](https://miguelarmengol.com/blog/applied-ai-engineering-notes/hamsters/) for more project notes.
